...
Read [scripts/bash_macros/README.md](../../../scripts/bash_macros/README.md) for bundle layout, registry, helpers, and `load_macros`. Helpers are `ns::_name` bodies (no short globals): [bash/macros.mdc](../../rules/bash/macros.mdc). Prefixes: [bash/naming.mdc](../../rules/bash/naming.mdc).
