...
Convention: each repo keeps `scripts/macros/` (`api/*.bash`, optional `helpers/`, `README.md`). After the shell starts, bundles are copied to `$ROS2_PROJECTS_WS_ROOT/build_ws/macros/<repo>/`.
