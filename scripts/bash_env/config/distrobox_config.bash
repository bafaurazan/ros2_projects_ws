...
# Distrobox backend constants. Sourced by launch/backends/run_distrobox.bash (host entry).
...
CONTAINER_SESSION_SETUP="/run/host${WS_DIR}/scripts/bash_env/launch/backends/run_distrobox.bash"
