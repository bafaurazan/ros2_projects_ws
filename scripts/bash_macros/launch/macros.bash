...
#   report ok/info/pull/push/merged/no upstream/manual, then one y/N
#   to apply safe pull --ff-only / push / switch+pull (merged tip into
#   develop or main). Paths required. Usage: git_ws <path> [path ...]
# @macros-end
